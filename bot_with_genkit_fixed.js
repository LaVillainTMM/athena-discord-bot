...
try {
  ...
  if (process.env.FIREBASE_CREDENTIALS) {
    ...
    // Set Google Application Credentials environment variable for Genkit
    // This tells Genkit where to find the credentials
    process.env.GOOGLE_APPLICATION_CREDENTIALS_JSON = process.env.FIREBASE_CREDENTIALS;
  }
  ...
  // Enable Genkit telemetry - it will now use the credentials we set above
